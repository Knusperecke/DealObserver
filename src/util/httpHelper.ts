export type HttpGetFunction = (url: string, requestImpl: XMLHttpRequest) => Promise<string>;
export function get(url: string, requestImpl = new XMLHttpRequest()): Promise<string> {
